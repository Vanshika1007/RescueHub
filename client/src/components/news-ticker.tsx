...
export default function NewsTicker() {
  ...
  const disasterNewsItems: NewsItem[] = (activeDisasters?.disasters || []).slice(0, 3).map(disaster => ({
    ...
    message: `🌍 ${disaster.name} - ${disaster.type} in ${disaster.location.region || disaster.location.country}. Status: ${disaster.status.toUpperCase()}`,
    timestamp: 'Live'
  }));
  ...
  const staticNewsItems: NewsItem[] = [
    {
      id: '1',
      type: 'warning',
      message: '🚨 Flood Warning: Heavy rainfall expected in coastal areas. Stay alert and avoid low-lying areas.',
      timestamp: '2 min ago'
    },
    {
      id: '2',
      type: 'info',
      message: '📢 Cyclone Update: Storm system moving towards eastern coast. Emergency shelters activated.',
    ...
    },
    {
      id: '4',
      type: 'info',
      message: '🏥 Medical Aid: Mobile medical units deployed in affected areas. Call emergency helpline for assistance.',
      timestamp: '2 hours ago'
    },
    {
      id: '5',
      type: 'warning',
      message: '🌊 Tsunami Watch: Coastal areas under watch. Residents advised to move to higher ground.',
